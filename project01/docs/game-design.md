...
- 玩家参与：备战阶段出现 3 个军令报价，玩家使用本局军资购买军令并可付费刷新。主动军令在战斗 HUD 中手动释放；被动军略在本局剩余波次持续生效，并可通过吞噬、合成和 Set 解锁形成高阶组合。
...
旧版英雄随机技能卡池、固定三张通用军令、旧版独立战备 3 选 1、装备、羁绊和旧版 24 人武将池不作为当前系统依据。备战阶段在 V1 中承担军令市场入口；具体卡牌与经济设计仍待继续。
