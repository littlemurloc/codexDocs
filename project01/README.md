...
- 三国幻想题材。
- 单人 PVE 爬层。
- 上中下 3 路、双方 3x3 站位自动战斗。
- 波次后备战抉择与本局 Roguelike 能力成长。
- 参考《暗黑地牢》的 6 选 4 技能装配。
- 主动技能可在自动释放与 HUD 技能卡牌手动释放之间取舍。
- 装备围绕关键词放大角色战斗流派。
...
- 战前在我方左侧 3x3 共 9 个站位格中摆放队伍，对抗右侧镜像 3x3 敌方站位。
- 战斗按上中下行优先选敌，并允许部分英雄通过所处格位触发站位被动。
- 备战阶段可关闭部分已上阵英雄主动技能自动释放，使其进入 HUD 技能卡牌池手动释放。
...
2. 进入 Y3 策划落表和原型制作。
3. 优先验证 3 路 3x3 站位选敌、站位被动、技能卡牌池、战备 3 选 1、奖励结算和 2 人/4 人差距。
